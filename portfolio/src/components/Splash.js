    ...
    return (
        <section id="splash" className="bg-zinc-900 min-h-screen z-999">
            <div className="relative">
                <div className="absolute h-fit left-[10%] md:left-[25%] lg:left-[35%]">
                    ...
                    <div className="absolute top-44 -left-4 w-72 h-72 bg-[#3b403b] rounded-full  filter blur-xl  animate-blob"></div>
                    <div className="absolute top-44 left-36 w-72 h-72 bg-[#30332f] rounded-full  filter blur-xl opacity-90 animate-blob animation-delay-2000"></div>
                    <div className="absolute top-96 left-20 w-72 h-72 bg-[#222A23] rounded-full  filter blur-xl  animate-blob animation-delay-4000"></div>
                    <div className="invisible lg:visible absolute top-[475px] left-64 w-72 h-72 bg-[#1c1f1d] rounded-full  filter blur-xl  animate-blob animation-delay-6000"></div>
            ...
            <div className="absolute bottom-10 z-10 w-auto mt-28 flex justify-center w-screen hover:animate-bounce">
                <a href="#about-me">
