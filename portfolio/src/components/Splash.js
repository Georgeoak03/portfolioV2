    ...
    return (
        <section id="splash" className="bg-zinc-900 min-h-screen">
            <div className="relative">
                <div className="absolute w-3/5 h-96 md:h-3/5 z-0 bg-[#222A23] top-52 left-[15%] md:left-1/4"></div>
                <div className="relative max-w-xs z-10 top-44 left-[10%] md:left-[15%]">
                    ...
                    <div className="z-10 w-12 md:w-1/2 mt-10 ml-[20%] md:left-[45%] md:top-50 text-left">
