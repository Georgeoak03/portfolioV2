...
export default function Navbar() {
    ...
    return (
        <section id="navbar">
            <header className="fixed w-full z-20 top-0 bg-zinc-900 bg-opacity-80 flex flex-wrap items-center justify-between mx-auto p-1 px-4">
                ...
                <div className="mobile-menu flex lg:hidden">
                    ...
                    right-0 px-8" onClick={() => setIsNavOpen((prev) => !prev)}>
                        <FontAwesomeIcon icon="fa-solid fa-bars" className="lg:collapse text-gray-700 hover:text-white text-4xl transition ease-in-out duration-1000 transform"/>
                    </div>
