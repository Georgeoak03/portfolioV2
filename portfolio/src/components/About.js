    ...
    return (
        <section id="about-me" className="bg-zinc-900">
            <m.div ref={ref}
                ...
                <div className="absolute z-0 bg-[#263d28] w-[175px] lg:w-[300px] h-6 top-28 left-[25%] lg:h-10 lg:left-[16%] lg:top-44 lg:w-[450px]"></div>
                <div className="absolute w-[85px] h-6 z-0 bg-[#263d28] top-44 left-[25%] lg:hidden"></div>
                <div className="w-36 flex absolute z-0 left-[55%] top-40 lg:w-72 lg:left-[60%] lg:top-72">
                ...
                <div className="relative flex-wrap-col left-[10%] top-40 z-10 w-4/5 md:w-[400px] md:left-[15%] md:top-72 lg:w-1/3 lg:top-40 lg:left-[22%]">
                ...
                <div className="lg:hidden relative flex-wrap-col m-auto justify-center space-x-3 z-10 w-fit lg:w-2/3 top-24 md:top-64 lg:top-52 p-6">
                ...
                <div className="lg:hidden relative flex m-auto justify-center w-fit top-24 p-0 md:top-64">
